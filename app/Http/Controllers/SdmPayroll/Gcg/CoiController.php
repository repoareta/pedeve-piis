...
class CoiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('modul-sdm-payroll.gcg.coi.lampiran_satu', compact('jabatan'));
    }
    ...
    public function lampiranDua()
    {
        ...
        return view('modul-sdm-payroll.gcg.coi.lampiran_dua', compact('jabatan'));
    }
    ...
    public function lampiranSatuPrint(Request $request, GcgCoi $gcgCoi)
    {
        ...
        $pdf = DomPDF::loadview('modul-sdm-payroll.gcg.coi.lampiran_satu_print', compact(
            'konflik',
            'tempat',
            'tanggal_efektif',
            'jabatan'
    ...
    public function lampiranDuaPrint(Request $request, GcgCoi $gcgCoi)
    {
        ...
        $pdf = DomPDF::loadview('modul-sdm-payroll.gcg.coi.lampiran_dua_print', compact(
            'tempat',
            'tanggal_efektif',
            'jabatan'
        ));
