...
class CoiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('modul-gcg.coi.lampiran-satu', compact('jabatan'));
    }
    ...
    public function lampiranSatuPrint(Request $request, GcgCoi $gcgCoi)
    {
        ...
        $pdf = DomPDF::loadview('modul-gcg.coi.lampiran-satu-print', compact(
            'konflik',
            'tempat',
            'tanggal_efektif',
            'jabatan'
    ...
    public function lampiranDuaPrint(Request $request, GcgCoi $gcgCoi)
    {
        ...
        $pdf = DomPDF::loadview('modul-gcg.coi.lampiran-dua-print', compact(
            'tempat',
            'tanggal_efektif',
            'jabatan'
        ));
