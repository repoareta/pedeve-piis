...
Route::prefix('kontroler')->name('modul_kontroler.')->group(function () {
    ...
    Route::name('jurnal_umum.')->group(function () {
        ...
        Route::get('jurnal-umum/index-json', [JurnalUmumController::class, 'indexJson'])->name('index.json');
    ...
    Route::name('postingan_kas_bank.')->group(function () {
        ...
        Route::get('postingan-kas-bank/index-json', [PostingKasBankController::class, 'indexJson'])->name('index.json');
    ...
    Route::name('tabel_deposito.')->group(function () {
        ...
        Route::get('tabel-deposito/index/index-json', [TabelDepositoController::class, 'indexJson'])->name('index.json');
    ...
    // Tabel 
    Route::prefix('tabel')->name('tabel.')->group(function () {
        ...
        Route::name('cash_judex.')->group(function () {
            ...
            Route::get('cash-judex/index/index-json', [CashJudexController::class, 'indexJson'])->name('index.json');
            ...
            Route::get('cash-judex/edit/{kode}', [CashJudexController::class, 'edit'])->name('edit');
        ...
        Route::name('jenis_biaya.')->group(function () {
            ...
            Route::get('jenis-biaya/index/index-json', [JenisBiayaController::class, 'indexJson'])->name('index.json');
            ...
            Route::get('jenis-biaya/edit/{kode}', [JenisBiayaController::class, 'edit'])->name('edit');
        ...
        Route::name('kas_bank_kontroler.')->group(function () {
            ...
            Route::get('kas-bank-kontroler/index/index-json', [KasBankKontrolerController::class, 'indexJson'])->name('index.json');
        ...
        Route::name('lokasi_kontroler.')->group(function () {
            ...
            Route::get('lokasi-kontroler/index/index-json', [LokasiKontrolerController::class, 'indexJson'])->name('index.json');
        ...
        Route::name('sandi_perkiraan.')->group(function () {
            ...
            Route::get('sandi-perkiraan/index/index-json', [SandiPerkiraanController::class, 'indexJson'])->name('index.json');
        ...
        Route::name('bulan_kontroler.')->group(function () {
            ...
            Route::get('bulan-kontroler/index/index-json', [BulanKontrolerController::class, 'indexJson'])->name('index.json');
        ...
        Route::name('main_account.')->group(function () {
            ...
            Route::get('main-account/index/index-json', [MainAccountController::class, 'indexJson'])->name('index.json');
