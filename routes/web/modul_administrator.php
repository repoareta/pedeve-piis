...
Route::prefix('administrator')->name('modul_administrator.')->group(function () {
    ...
    Route::name('set_user.')->group(function () {
        ...
        Route::post('set-user/index/index-json', [SetUserController::class, 'indexJson'])->name('search.index');
    ...
    Route::name('set_menu.')->group(function () {
        ...
        Route::post('set-menu/index/index-json', [SetMenuController::class, 'indexJson'])->name('search.index');
    ...
    Route::name('set_function.')->group(function () {
        ...
        Route::post('set-function/index/index-json', [SetFunctionController::class, 'indexJson'])->name('search.index');
    ...
    Route::name('tabel_menu.')->group(function () {
        ...
        Route::post('tabel-menu/index/index-json', [TabelMenuController::class, 'indexJson'])->name('search.index');
    ...
    Route::name('log.')->group(function () {
        ...
        Route::post('log/index-json', [LogController::class, 'indexJson'])->name('search.index');
    });
    //end log
});
