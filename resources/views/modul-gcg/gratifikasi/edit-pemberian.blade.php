...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    <div class="card-header justify-content-start">
        <div class="card-title">
            ...
            <h3 class="card-label">
                Edit Pemberian Hadiah/Cindera Mata dan Hiburan (Entertaiment)
            </h3>
        </div>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-xl-12">
                <form class="form" id="formPemberian" action="{{ route('modul_gcg.gratifikasi.update', ['gratifikasi' => $gratifikasi]) }}" method="POST">
					@csrf

					<div class="form-group row">
						<label for="tanggal_pemberian" class="col-3 col-form-label">Tanggal Pemberian</label>
						<div class="col-9">
							<input class="form-control bg-secondary" readonly type="text" name="tanggal_pemberian" id="tanggal_pemberian" value="{{ $gratifikasi->tgl_gratifikasi?->format('Y-m-d') }}">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-9">
							<input class="form-control bg-secondary" readonly type="text" name="bentuk_jenis_pemberian" id="bentuk_jenis_pemberian" value="{{ $gratifikasi->bentuk }}">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-9">
							<input class="form-control bg-secondary" readonly type="text" name="penerima_hadiah" id="penerima_hadiah" value="{{ $gratifikasi->penerima }}">
						</div>
					</div>
