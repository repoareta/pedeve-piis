...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        ...
        <div class="col-12">
            <form action="{{ route('modul_gcg.gratifikasi.report.personal.export') }}" target="_blank" class="col-12 form" id="search-form" method="POST">
                @csrf
...
<script type="text/javascript">
	$(document).ready(function () {
		var t = $('#kt_table').DataTable({
			...
			serverSide: true,
			ajax: {
				url: "{{ route('modul_gcg.gratifikasi.report.personal.json') }}",
				data: function (d) {
