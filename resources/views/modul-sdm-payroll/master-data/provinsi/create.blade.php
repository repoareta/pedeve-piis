...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-12">
                <form class="form" id="formProvinsi" action="{{ route('modul_sdm_payroll.provinsi.store') }}" method="POST">
					@csrf
...
@push('page-scripts')
{!! JsValidator::formRequest('App\Http\Requests\ProvinsiStore', '#formProvinsi') !!}
@endpush
