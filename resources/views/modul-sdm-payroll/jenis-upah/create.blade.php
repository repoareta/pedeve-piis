    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-12">
                ...
                <form class="form" id="formJenisUpah" action="{{ route('modul_sdm_payroll.jenis_upah.store') }}" method="POST">
					@csrf
					...
					<div class="form-group row">
						...
						<div class="col-10">
							<input class="form-control" type="text" maxlength="1" name="cetak" id="cetak" autocomplete="off">
						</div>
					</div>
					<div class="row">
                        <div class="col-2"></div>
...
@push('page-scripts')
{!! JsValidator::formRequest('App\Http\Requests\JenisUpahStore', '#formJenisUpah'); !!}
<script>
