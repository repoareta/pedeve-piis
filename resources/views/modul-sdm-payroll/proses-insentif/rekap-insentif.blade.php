...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-12">
                <form class="form" action="{{ route('modul_sdm_payroll.proses_insentif.rekap_insentif.export') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            <input class="form-control" type="text" value="Manajer Treasurry, " name="jabatan" id="jabatan" required autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
