            ...
            <div class="col-xl-12">
                <form class="form form--label-right" action="{{ route('modul_sdm_payroll.proses_gaji.slip_gaji.export') }}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <select name="nopek" id="select-debetdari" class="form-control select2" required oninvalid="this.setCustomValidity('Nama Pegawai Harus Diisi..')" onchange="setCustomValidity('')">
