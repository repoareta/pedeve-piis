        ...
        <table width="100%">
                ...
                <tr>
                    <td align="left" style="padding-left:100px;font-family: sans-serif">
                        <table>
                            <tr>
                                <td><font style="font-size: 12pt;font-weight: bold ">DAFTAR PEMBAYARAN GAJI KOMITE </font></td>
                            </tr>
                            <tr>
                ...
                <tr>
                    <td>
                        <table width="100%" style="border-collapse: collapse;" border="1">
                            ...
                            <tr>
                                <td style="padding-left:12px;font-size: 8pt;font-weight: bold" colspan="11">KOMITE</td>
                            </tr>
                            <?php $a=0; ?>
