...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-12">
                <form class="form" action="{{ route('modul_sdm_payroll.master_tabungan.store') }}" id="form-create" method="POST">
                    @csrf
                    <div class="form-group form-group-last">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control money" type="text" name="perusahaan" autocomplete="off">
                            </div>
                        </div>
...
@push('page-scripts')
{!! JsValidator::formRequest('App\Http\Requests\MasterTabunganStoreRequest', '#form-create'); !!}
@endpush
