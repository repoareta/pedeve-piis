            ...
            <div class="col-xl-12">
                <form class="form" id="form-create">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <select name="nopek" class="form-control select2" style="width: 100% !important;" autocomplete="off" oninvalid="this.setCustomValidity('Pegawai Harus Diisi..')">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <select name="aard" id="aard" class="form-control select2" style="width: 100% !important;" autocomplete="off" oninvalid="this.setCustomValidity('Potongan Harus Diisi..')">
                                <option value="">- Pilih -</option>
                    ...
                    <?php $ccl =1; $jmlcc=999; ?>
                        ...
                        <div class="col-10">
                            <input class="form-control" name="ccl" type="text" value="{{ $ccl }}" id="ccl" size="3" maxlength="3" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-2 col-form-label">Jml Cicilan<span class="text-danger">*</span></label>
                        <div class="col-10">
                            <input class="form-control" name="jmlcc" type="text" value="{{ $jmlcc }}" id="jmlcc" size="3" maxlength="3" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-2 col-form-label">Cicilan/Bulan<span class="text-danger">*</span></label>
                        <div class="col-10">
                            <input class="form-control nominal" name="nilai" type="text" value="0" size="25" maxlength="25" autocomplete="off">
                        </div>
                    </div>
...
@push('page-scripts')
{!! JsValidator::formRequest('App\Http\Requests\PotonganGajiOtomatis') !!}
