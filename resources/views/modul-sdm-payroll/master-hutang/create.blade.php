...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12">
                <form class="form" id="formMasterHutang" action="{{ route('modul_sdm_payroll.master_hutang.store') }}" method="POST">
					@csrf
					...
					<div class="form-group row">
						...
						<div class="col-10">
							<input class="form-control money" type="text" name="last_amount" id="last_amount">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-10">
							<input class="form-control money" type="text" name="current_amount" id="current_amount">
						</div>
					</div>
...
@push('page-scripts')
{!! JsValidator::formRequest('App\Http\Requests\MasterHutangStore', '#formMasterHutang') !!}
