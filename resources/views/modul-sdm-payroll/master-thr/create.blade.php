...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12">
                <form class="form" id="formMasterThr" action="{{ route('modul_sdm_payroll.master_thr.store') }}" method="POST">
					@csrf
					...
					<div class="form-group row">
						<label for="nama" class="col-2 col-form-label">Komponen Upah</label>
						<div class="col-10">
...
@push('page-scripts')
{!! JsValidator::formRequest('App\Http\Requests\MasterThrStore', '#formMasterThr') !!}
