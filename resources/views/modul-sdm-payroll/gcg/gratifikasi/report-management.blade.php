...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        ...
        <div class="col-12">
            <form action="{{ route('modul_sdm_payroll.gcg.gratifikasi.report.management.export') }}" class="kt-form col-12 kt-form--label-right" method="GET" id="search-form" target="_blank">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-4">
                        <select class="form-control select2" name="fungsi" id="fungsi">
                            <option value="">- Pilih -</option>
