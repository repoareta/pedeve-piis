    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-12">
                ...
                <form class="form" id="formRekeningPekerja" action="{{ route('modul_sdm_payroll.rekening_pekerja.store') }}" method="POST">
					@csrf
					...
					<div class="form-group row">
						...
						<div class="col-10">
							<input class="form-control" type="text" name="rekening" id="nama" autocomplete="off">
						</div>
					</div>
					<div class="form-group row">
						<label for="nama-input" class="col-2 col-form-label">Atas Nama<span class="text-danger">*</span></label>
						<div class="col-10">
							<input class="form-control" type="text" name="atasnama" id="nama" autocomplete="off">
						</div>
					</div>
					<div class="row">
                        <div class="col-2"></div>
...
@push('page-scripts')
{!! JsValidator::formRequest('App\Http\Requests\RekeningPekerjaStore', '#formRekeningPekerja'); !!}
<script>
