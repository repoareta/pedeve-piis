...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        <form action="{{ route('modul_sdm_payroll.master_ptkp.update') }}" method="post" id="form-edit">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input class="form-control money" name="nilai" type="text" autocomplete="off" value="{{ $ptkp->nilai }}">
                    @error('nilai')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
...
@push('page-scripts')
{!! JsValidator::formRequest('App\Http\Requests\MasterPTKPUpdateRequest', '#form-edit'); !!}
