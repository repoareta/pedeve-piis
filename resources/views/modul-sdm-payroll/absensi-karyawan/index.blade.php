			...
			<form action="{{ route('modul_sdm_payroll.absensi_karyawan.mapping') }}" method="POST">
				...
				<div class="modal-body">
					<div class="form-group row">
						...
						<div class="col-10">
							<select class="form-control select2" style="width: 100%;" name="nopeg" style="width: 100%;" required>
					...
					<div class="form-group row">
						...
						<div class="col-10">
							<select class="form-control select2" style="width: 100%;" name="noabsen" style="width: 100%;" required>
								<option value="">- Pilih -</option>
