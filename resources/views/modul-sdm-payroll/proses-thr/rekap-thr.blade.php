...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-12">
                <form class="form form--label-right" action="{{ route('modul_sdm_payroll.proses_thr.rekap_thr.export') }}" method="post">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            <input class="form-control" type="text" value="" name="nama" id="nama" size="50" maxlength="200" required oninvalid="this.setCustomValidity('Penandatanganan Harus Diisi..')" oninput="setCustomValidity('')" autocomplete='off'>
                        </div>
                        <label class="col-1 col-form-label">Jabatan<span class="text-danger">*</span></label>
                        <div class="col-3" >
                            <input class="form-control" type="text" value="Sekretaris Perseroan, " name="jabatan" id="jabatan" size="50" maxlength="200" required oninvalid="this.setCustomValidity('Jabatan Harus Diisi..')" oninput="setCustomValidity('')" autocomplete='off'>
                        </div>
                    </div>
                    <div class="form-group row">
