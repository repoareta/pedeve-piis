...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12">
                <form action="{{ route('modul_sdm_payroll.master_pegawai.upah_all_in.store', ['pegawai' => $pegawai->nopeg]) }}" method="post" id="form-create-upah-all-in">
                    @csrf
...
@push('page-scripts')
{!! JsValidator::formRequest('App\Http\Requests\UpahAllInStoreRequest', '#form-create-upah-all-in') !!}
@endpush