            ...
            <div class="col-12">
                ...
                <form method="POST" id="form-edit">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <select name="bagian" id="bagian" style="width: 100%;" class="form-control selectpicker" data-live-search="true" required oninvalid="this.setCustomValidity('Bagian Harus Diisi..')" onchange="setCustomValidity('')">
