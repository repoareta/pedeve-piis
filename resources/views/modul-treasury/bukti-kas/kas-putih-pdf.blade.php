...
<body>
    ...
    <main>
                ...
                <thead>
                    <tr>
                        ...
                        <td colspan="2" nowrap>
                            ...
                            <br>
                            BLN/THN &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ substr($kasdoc->thnbln, 0, 4) }} / {{ substr($kasdoc->thnbln, -2, 2) }}
                            <br>
        ...
        <div class="row">
            <table class="table" style="width:100%; border-top:2px solid white;">
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <td colspan="1" class="text-center" valign="top" style="border-bottom: 2px solid #FFFFFF;">
                            Permintaan Bayar,
                            <br>
