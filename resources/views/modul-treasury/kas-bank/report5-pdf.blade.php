        ...
        <header>
            ...
            <?php 
                ...
                <td align="center" style="padding-left:200px;">
                   ...
                   <font style="font-size: 10pt;font-weight: bold ">DETAIL KAS/BANK PER CASH JUDEX PER JENIS BIAYA</font><br>
                   <font style="font-size: 10pt;font-weight: bold "> CASH JUDEX BULAN  {{strtoupper($bulan) }} {{ $request->tahun }} </font><br>
                    </td>
                </tr>
            </table>
        </header>
            ...
            <table width="100%" style="font-family: sans-serif;border-collapse: collapse;" border="1">
                ...
                <tbody>
                    ...
                    <?php 
                     ...
                     ?>
                        <td colspan="11" style="font-size: 8pt;text-align:right;">TOTAL PER JB</td>
