...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">
                Tabel Cetak Per Bagian
            </h3>
        </div>
    </div>

    <div class="card-body">
        <form class="kt-form" action="{{route('kas_bank.cetak4')}}" method="POST" target="_blank">
            @csrf
            <div class="form-group row">
                <label for="dari-input" class="col-2 col-form-label">C.Judex<span class="text-danger">*</span></label>
                <div class="col-10">
                    <select name="cj" id="select-debetdari" class="form-control select2" style="width: 100%;" required oninvalid="this.setCustomValidity('C.Judex Harus Diisi..')" onchange="setCustomValidity('')">
