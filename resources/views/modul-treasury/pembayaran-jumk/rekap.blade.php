...
<div class="card card-custom" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        <form class="form" action="{{ route('pembayaran_jumk.export') }}" method="POST">
			@csrf
				...
				<div class="form__actions">
					<div class="row">
						...
						<div class="col-10">
							...
							<a href="{{ url('perbendaharaan/pembayaran-jumk/rekaprc') }}/{{ $docs}}" class="btn btn-primary"><i class="fa fa-print"></i>Cetak RC</a>
						</div>
					</div>
				</div>
			</div>
