...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        <form action="{{ route('rekap_harian_kas.ctkharian') }}" method="post">
            ...
            <div class="form-group row">
                <label for="" class="col-2 col-form-label">No.Kas/Bank<span class="text-danger">*</span></label>
                <div class="col-10">
            ...
            <div class="form-group row">
                <label class="col-2 col-form-label">Setuju<span class="text-danger">*</span></label>
                <div class="col-4">
                ...
                <label class="col-2 col-form-label">Dibuat Oleh<span class="text-danger">*</span></label>
                <div class="col-4">
            ...
            <div class="form-group row">
                <div class="col-2"></div>
                <div class="col-10">
                    <a href="{{ route('rekap_harian_kas.index') }}" class="btn btn-warning"><i class="fa fa-reply" aria-hidden="true"></i>Batal</a>
