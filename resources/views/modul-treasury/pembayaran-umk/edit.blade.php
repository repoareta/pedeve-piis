...
<div class="card card-custom" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        <form class="form" id="form-edit" action="{{ route('pembayaran_umk.update') }}">
            @csrf
            <div class="portlet__body">
                <div class="form-group form-group-last">
                    <div class="alert alert-custom alert-default" role="alert">
                        <div class="alert-text">
							Header Menu Edit Pembayaran UMK
                        </div>
                    </div>
                    <?php
                        $nodok = $data->docno;
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            <input type="text" class="form-control"  value="{{ $nomor}}" size="1" maxlength="1" name="nomor" id="nomor" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-4">
                        ...
                        <input class="form-control" type="hidden" value="{{ $data->thnbln}}" name="bulanbuku" id="bulanbuku" size="6" maxlength="6" readonly>
    ...
    <div class="card-body">
        <table class="table table-bordered" id="kt_table">
            ...
            <tbody>
                ...
                <?php $no++; ?>
                <tr>
                    <td scope="row" align="center" class="text-center"><label class="radio radio-outline radio-outline-2x radio-primary"><input type="radio" name="btn-radio" nodok="{{ $data_d->docno }}" nourut="{{ $data_d->lineno }}"  class="btn-radio"><span></span></label></td>
			...
			<span id="form_result"></span>
                <form class="form" id="form-create-detail"  enctype="multipart/form-data">
					...
					<div class="form-group row">
						...
						<div class="col-10">
							<select name="lapangan" class="form-control select2" style="width: 100% !important;">
								<option value="">- Pilih -</option>
...
@push('page-scripts')
{!! JsValidator::formRequest('App\Http\Requests\PembayaranUMKStoreRequest', '#form-edit'); !!}
