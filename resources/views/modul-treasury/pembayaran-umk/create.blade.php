...
<div class="card card-custom" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        <form class="form" id="form-create" method="POST" action="{{ route('pembayaran_umk.store') }}">
            @csrf
            <div class="portlet__body">
                <div class="form-group form-group-last">
                    <div class="alert alert-custom alert-default" role="alert">
                        <div class="alert-text">
							Header Permintaan Pembayaran UMK
                        </div>
                    </div>
...
@push('page-scripts')
{!! JsValidator::formRequest('App\Http\Requests\PembayaranUMKStoreRequest', '#form-create'); !!}
