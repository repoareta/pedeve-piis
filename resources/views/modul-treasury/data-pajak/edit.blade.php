            ...
            <div class="kt-portlet__body">
                <div class="form-group form-group-last">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <select class="form-control kt-select2" style="width: 100% !important;" required oninvalid="this.setCustomValidity('Pegawai Harus Diisi..')" onchange="setCustomValidity('')" disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <select class="form-control kt-select2" style="width: 100% !important;" required oninvalid="this.setCustomValidity('Jenis Harus Diisi..')" onchange="setCustomValidity('')" disabled>
