    ...
    <div class="card-body">
        <form method="POST" id="form-create">
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
<<<<<<< Updated upstream
                    <select name="nodok" id="nodok" class="form-control select2" style="width: 100% !important;" required oninvalid="this.setCustomValidity('No. Dokumen Harus Diisi..')">
=======
                    <select name="nodok" id="nodok" class="form-control selectpicker" data-live-search="true" required>
>>>>>>> Stashed changes
