...
<div class="card card-custom" id="kt_page_sticky_card">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">
                Cetak Kas Bank Pembayaran Permintaan Bayar
            </h3>
        </div>
    </div>

    <div class="card-body">
        <form class="kt-form kt-form--label-right" action="{{ route('pembayaran_pbayar.export') }}" method="post">
			@csrf
				...
				<div class="kt-form__actions">
					<div class="row">
						...
						<div class="col-10">
							...
							<a  href="{{url('perbendaharaan/pembayaran-pbayar/rekaprc')}}/{{$docs}}" class="btn btn-primary"><i class="fa fa-print" aria-hidden="true"></i>Cetak RC</a>
						</div>
					</div>
				</div>
			</div>
