    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-12">
                ...
                <form class="form" action="{{ route('modul_umum.perjalanan_dinas.pertanggungjawaban.detail.store', [
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control qty" type="text" name="qty" id="qty">
                        </div>
                    </div>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$("#formPPanjarDinasDetail").on('submit', function(e){
            e.preventDefault();
