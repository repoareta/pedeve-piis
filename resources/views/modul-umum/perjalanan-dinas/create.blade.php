            ...
            <div class="col-xl-12">
                ...
                <form class="form" id="formPanjarDinas" action="{{ route('modul_umum.perjalanan_dinas.store') }}" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-5">
							<select class="form-control select2" style="width: 100% !important;" name="jabatan" id="jabatan" readonly>
					...
					<div class="form-group row">
						...
						<div class="col-10">
							<select class="form-control select2" style="width: 100% !important;" name="jenis_dinas" id="jenis_dinas">
