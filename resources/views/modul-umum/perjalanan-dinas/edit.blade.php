			...
			<form class="kt-form" action="" method="POST" id="formPanjarDinasDetail">
				<div class="modal-body">
					...
					<div class="form-group row">
						...
						<div class="col-10">
							<select class="form-control select2" style="width: 100%;" id="nopek_detail" name="nopek_detail" style="width: 100% !important;">
								<option value="">- Pilih Nopek -</option>
								@foreach ($pegawai_list as $pegawai)
					...
					<div class="form-group row">
						...
						<div class="col-10">
							<select class="form-control select2" style="width: 100%;" name="jabatan_detail" readonly id="jabatan_detail" style="width: 100% !important;">
								<option value="">- Pilih Jabatan -</option>
								@foreach ($jabatan_list as $jabatan)
