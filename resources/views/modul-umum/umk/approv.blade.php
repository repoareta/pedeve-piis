...
<div class="card card-custom">
    ...
    <div class="card-body">
        <form action="{{ route('modul_umum.uang_muka_kerja.store.app') }}" method="post" id="form-approve">
            @csrf
            <div class="form-group row">
                <label for="mulai-input" class="col-2 col-form-label">No.Dokumen</label>
                <div class="col-10">
                    <input type="text" class="form-control disabled bg-secondary" name="noumk" value="{{$data->no_umk}}" readonly />
