...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12">
                <form class="form" id="formAnggaran" action="{{ route('modul_umum.anggaran.update', ['anggaran' => $anggaran]) }}" method="POST">
					@csrf
					<div class="form-group row">
						<label for="tahun" class="col-2 col-form-label">Tahun</label>
						<div class="col-10">
							<input class="form-control tahun" type="text" name="tahun" id="tahun" value="{{ $anggaran->tahun }}">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-10">
							<input class="form-control money" type="text" name="nilai" id="nilai" value="{{ $anggaran->nilai_real }}">
						</div>
					</div>
