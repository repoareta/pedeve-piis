	...
	<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
		...
		<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
			...
			<ul class="menu-nav">
				...
				<!--begin::Umum Menu-->
				@include('layouts.partials._menu_aside.modul_umum')
				<!--end::Umum Menu-->

				<!--begin::SDM & Payroll Menu-->
				@include('layouts.partials._menu_aside.modul_sdm_payroll')
				<!--end::SDM & Payroll Menu-->

				<!--begin::Treasury Menu-->
				@include('layouts.partials._menu_aside.modul_treasury')
				<!--end::Treasury Menu-->

				<!--begin::Kontroler Menu-->
				@include('layouts.partials._menu_aside.modul_kontroler')
				<!--end::Kontroler Menu-->

				<!--begin::Customer Management Menu-->
				@include('layouts.partials._menu_aside.modul_customer_management')
				<!--end::Customer Management Menu-->
				
				<!--begin::Administrator Menu-->
				@include('layouts.partials._menu_aside.modul_administrator')
