	...
	<div class="kt-container  kt-container--fluid ">
		<div class="kt-subheader__main">
			<h3 class="kt-subheader__title">
				Cetak Rugi Laba Konsolidasi </h3>
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="" class="kt-subheader__breadcrumbs-link">
					Kontroler </a>
				<span class="kt-subheader__breadcrumbs-separator"></span>
				<span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Cetak Rugi Laba Konsolidasi</span>
			</div>
		</div>
	</div>
</div>
...
<div class="kt-portlet kt-portlet--mobile">
	...
	<div class="kt-portlet__body">
		<form class="kt-form kt-form--label-right" action="{{route('laba_rugi_konsolidasi.export.laba.rugi.konsolidasi')}}" method="post">
			{{csrf_field()}}
			<div class="kt-portlet__body">
