	...
	<div class="kt-container  kt-container--fluid ">
		<div class="kt-subheader__main">
			<h3 class="kt-subheader__title">
				Cetak Biaya Pegawai Dan Kantor </h3>
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="" class="kt-subheader__breadcrumbs-link">
					Kontroler </a>
				<span class="kt-subheader__breadcrumbs-separator"></span>
				<span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Cetak Biaya Pegawai Dan Kantor</span>
			</div>
		</div>
	</div>
</div>
...
<div class="kt-portlet kt-portlet--mobile">
	<div class="kt-portlet__head kt-portlet__head--lg">
		<div class="kt-portlet__head-label">
			...
			<h3 class="kt-portlet__head-title">
				Tabel Cetak Biaya Pegawai Dan Kantor
			</h3>			
		</div>
	...
	<div class="kt-portlet__body">
		<form class="kt-form" action="{{route('biaya_pegawai.export_biaya_pegawai')}}" method="post">
			@csrf
			<div class="kt-portlet__body">
				...
				<div class="col-4">
						...
						?>
						<select class="form-control select2" style="width: 100%;" name="bulan1">
				...
				<div class="col-5">
						<select class="form-control select2" style="width: 100%;" name="bulan2">
							<option value="01" <?php if($bulan  == '01' ) echo 'selected' ; ?>>Januari</option>
							<option value="02" <?php if($bulan  == '02' ) echo 'selected' ; ?>>Februari</option>
							<option value="03" <?php if($bulan  == '03' ) echo 'selected' ; ?>>Maret</option>
							<option value="04" <?php if($bulan  == '04' ) echo 'selected' ; ?>>April</option>
