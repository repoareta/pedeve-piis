            ...
            <div class="col-xl-12">
                <div class="form-group mb-8">
                    <div class="alert alert-custom alert-default" role="alert">
                        <div class="alert-text">Header Tabel Cetak Rincian Transaksi D2 Per Periode</div>
                    </div>
                </div>
                <form class="form" id="formD2Periode" action="{{ route('modul_kontroler.d2_periode.export') }}" method="GET" target="_blank">
					...
					<div class="form-group row">
						<label for="bulan-tahun-input" class="col-2 col-form-label">Bulan<span class="text-danger">*</span></label>
						<div class="col-4">
                            @php
                    ...
                    <div class="form-group row">
						<label for="dari-input" class="col-2 col-form-label">Tahun<span class="text-danger">*</span></label>
						<div class="col-10">
...
@push('page-scripts')
{{-- {!! JsValidator::formRequest('App\Http\Requests\D2PeriodeStore', '#formD2Periode'); !!} --}}
<script>
    $(document).ready(function () {
		$('.cariaccount').select2({
			...
			allowClear: true,
			ajax: {
				url: "{{ route('modul_kontroler.d2_periode.search.account') }}",			
