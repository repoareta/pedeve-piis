            ...
            <div class="col-xl-12">
                <div class="form-group mb-8">
                    <div class="alert alert-custom alert-default" role="alert">
                        <div class="alert-text">Header Cash Judex</div>
                    </div>
                </div>
                <form class="form" id="formCashJudex" action="{{ route('modul_kontroler.tabel.cash_judex.store') }}" method="POST">
					@csrf
...
@push('page-scripts')
{!! JsValidator::formRequest('App\Http\Requests\CashJudexStore', '#formCashJudex'); !!}
<script>
