            ...
            <div class="col-xl-12">
                ...
                <form class="form" id="formMainAccount" action="{{ route('modul_kontroler.tabel.main_account.update') }}" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-10">
							<input class="form-control" type="text" name="pengali" id="pengali" value="{{ $data->pengali }}" autocomplete="off">
						</div>
					</div>
					<div class="form-group row">
						<label for="pengali-input" class="col-2 col-form-label">Pengali Tampil<span class="text-danger">*</span></label>
						<div class="col-10">
							<input class="form-control" type="text" name="pengali_tampil" id="pengali_tampil" value="{{ $data->pengali_tampil }}" autocomplete="off">
						</div>
					</div>
					<div class="form-group row">
