    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-12">
                ...
                <form class="form" id="formMainAccount" action="{{ route('modul_kontroler.tabel.main_account.update') }}" method="POST">
					@csrf
					<div class="form-group row">
						<label for="jenis-input" class="col-2 col-form-label">Jenis<span class="text-danger">*</span></label>
						<div class="col-10">
							<input class="form-control" type="text" name="jenis" id="jenis" value="{{ $data->jenis }}" autocomplete="off">
						</div>
					</div>
					<div class="form-group row">
						<label for="batas-awal-input" class="col-2 col-form-label">Batas Awal<span class="text-danger">*</span></label>
						<div class="col-10">
							<input class="form-control" type="text" name="batas_awal" id="batas_awal" value="{{ $data->batas_awal }}" autocomplete="off">
						</div>
					</div>
					<div class="form-group row">
						<label for="batas-akhir-input" class="col-2 col-form-label">Batas Akhir<span class="text-danger">*</span></label>
						<div class="col-10">
							<input class="form-control" type="text" name="batas_akhir" id="batas_akhir" value="{{ $data->batas_akhir }}" autocomplete="off">
						</div>
					</div>
					<div class="form-group row">
						<label for="urutan-input" class="col-2 col-form-label">Urutan<span class="text-danger">*</span></label>
						<div class="col-10">
							<input class="form-control" type="text" name="urutan" id="urutan" value="{{ $data->urutan }}" autocomplete="off">
						</div>
					</div>
					<div class="form-group row">
						<label for="pengali-input" class="col-2 col-form-label">Pengali<span class="text-danger">*</span></label>
						<div class="col-10">
							<input class="form-control" type="number" name="pengali" id="pengali" value="{{ $data->pengali }}" autocomplete="off">
						</div>
					</div>
					<div class="form-group row">
						<label for="pengali-input" class="col-2 col-form-label">Pengali Tampil<span class="text-danger">*</span></label>
						<div class="col-10">
							<input class="form-control" type="number" name="pengali_tampil" id="pengali_tampil" value="{{ $data->pengali_tampil }}" autocomplete="off">
						</div>
					</div>
					<div class="form-group row">
						<label for="sub-akun-input" class="col-2 col-form-label">Sub Akun<span class="text-danger">*</span></label>
						<div class="col-10">
							<input class="form-control" type="text" name="sub_akun" id="sub_akun" value="{{ $data->sub_akun }}" autocomplete="off">
						</div>
					</div>
					<div class="form-group row">
						<label for="lokasi-input" class="col-2 col-form-label">Lokasi<span class="text-danger">*</span></label>
						<div class="col-10">
							<input class="form-control" type="text" name="lokasi" id="lokasi" value="{{ $data->lokasi }}" autocomplete="off">
						</div>
					</div>
					<div class="row">
                        <div class="col-2"></div>
