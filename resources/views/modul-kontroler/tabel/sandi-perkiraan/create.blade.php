    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-12">
                ...
                <form class="form" id="formSandiPerkiraan" action="{{ route('modul_kontroler.tabel.sandi_perkiraan.store') }}" method="POST">
					@csrf
...
@push('page-scripts')
{!! JsValidator::formRequest('App\Http\Requests\SandiPerkiraanStore', '#formSandiPerkiraan'); !!}
<script>
