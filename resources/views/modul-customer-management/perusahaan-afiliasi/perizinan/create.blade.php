...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-12">
                <form class="form" action="{{ route('modul_cm.perusahaan_afiliasi.perizinan.store', ['perusahaan_afiliasi' => $perusahaan_afiliasi->id]) }}" method="POST" id="form-create" enctype="multipart/form-data">
                    @csrf
...
@push('page-scripts')
{!! JsValidator::formRequest('App\Http\Requests\PerizinanStore', '#form-create') !!}
