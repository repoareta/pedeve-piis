...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-12">
                <form class="form" action="{{ route('modul_cm.perusahaan_afiliasi.akta.update', ['perusahaan_afiliasi' => $perusahaan_afiliasi->id, 'akta' => $akta]) }}" method="POST" id="form-edit" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
						...
						<div class="col-10">
							<input class="form-control" type="text" name="jenis_akta" id="jenis_akta" value="{{ $akta->jenis }}">
						</div>
                    </div>
                    ...
                    <div class="form-group row">
						...
						<div class="col-10">
							<input class="form-control" type="text" name="nomor_akta" id="nomor_akta" value="{{ $akta->nomor_akta }}">
						</div>
                    </div>
                    ...
                    <div class="form-group row">
						...
						<div class="col-10">
							<input class="form-control datepicker" type="text" name="tanggal_akta" id="tanggal_akta" autocomplete="off" value="{{ date('d-m-Y', $akta->tanggal_akta) }}">
						</div>
                    </div>
                    ...
                    <div class="form-group row">
						...
						<div class="col-10">
							<input class="form-control" type="text" name="notaris" id="notaris" value="{{ $akta->notaris }}">
						</div>
                    </div>
                    ...
                    <div class="form-group row">
						...
						<div class="col-10">
							<input class="form-control datepicker" type="text" name="tmt_berlaku" id="tmt_berlaku" autocomplete="off" value="{{ date('d-m-Y', strtotime($akta->tmt_mulai)) }}">
						</div>
                    </div>
                    ...
                    <div class="form-group row">
						...
						<div class="col-10">
							<input class="form-control datepicker" type="text" name="tmt_berakhir" id="tmt_berakhir" autocomplete="off" value="{{ date('d-m-Y', strtotime($akta->tmt_akhir)) }}">
						</div>
                    </div>
