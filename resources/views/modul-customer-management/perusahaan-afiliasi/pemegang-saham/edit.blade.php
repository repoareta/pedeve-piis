            ...
            <div class="col-xl-12">
                <form class="form" action="{{ route('modul_cm.perusahaan_afiliasi.pemegang_saham.update', 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control persen" type="text" name="kepemilikan" id="kepemilikan" value="{{ $pemegang_saham->kepemilikan }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control saham" type="text" name="jumlah_lembar_saham_pemegang_saham" id="jumlah_lembar_saham_pemegang_saham" value="{{ $pemegang_saham->jumlah_lembar_saham }}">
                        </div>
                    </div>
